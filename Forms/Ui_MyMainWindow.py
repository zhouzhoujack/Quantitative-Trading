...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.startPushButton.setGeometry(QtCore.QRect(110, 610, 81, 31))
        self.startPushButton.setObjectName("startPushButton")
        self.testConnectPushButton = QtWidgets.QPushButton(self.groupBox)
        self.testConnectPushButton.setGeometry(QtCore.QRect(0, 610, 91, 31))
        ...
        self.stopPushButton.setGeometry(QtCore.QRect(200, 610, 81, 31))
        self.stopPushButton.setObjectName("stopPushButton")
        self.clearPushButton = QtWidgets.QPushButton(self.groupBox)
        self.clearPushButton.setEnabled(True)
        self.clearPushButton.setGeometry(QtCore.QRect(300, 610, 81, 31))
