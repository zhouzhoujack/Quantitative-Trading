...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1256, 754)
        MainWindow.setIconSize(QtCore.QSize(30, 30))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 411, 721))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(0, 200, 401, 151))
        self.groupBox_3.setObjectName("groupBox_3")
        self.formLayoutWidget_3 = QtWidgets.QWidget(self.groupBox_3)
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(0, 20, 401, 131))
        ...
        self.tokenLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_3)
        self.tokenLineEdit.setInputMask("")
        self.tokenLineEdit.setText("")
        self.tokenLineEdit.setObjectName("tokenLineEdit")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.tokenLineEdit)
        self.ding_secretLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_3)
        self.ding_secretLineEdit.setEchoMode(QtWidgets.QLineEdit.Password)
        self.ding_secretLineEdit.setObjectName("ding_secretLineEdit")
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.ding_secretLineEdit)
        ...
        self.line.setGeometry(QtCore.QRect(0, 650, 411, 20))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.startPushButton = QtWidgets.QPushButton(self.groupBox)
        self.startPushButton.setGeometry(QtCore.QRect(110, 680, 91, 31))
        self.startPushButton.setObjectName("startPushButton")
        self.testConnectPushButton = QtWidgets.QPushButton(self.groupBox)
        self.testConnectPushButton.setGeometry(QtCore.QRect(0, 680, 91, 31))
        self.testConnectPushButton.setObjectName("testConnectPushButton")
        self.groupBox_4 = QtWidgets.QGroupBox(self.groupBox)
        self.groupBox_4.setGeometry(QtCore.QRect(0, 360, 401, 231))
        ...
        self.formLayoutWidget_4.setGeometry(QtCore.QRect(0, 20, 401, 201))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_14.setText(_translate("MainWindow", "钉钉机器人"))
        self.tokenLineEdit.setPlaceholderText(_translate("MainWindow", "access_token"))
        self.ding_secretLineEdit.setPlaceholderText(_translate("MainWindow", "secret"))
        ...
        self.label_16.setText(_translate("MainWindow", "Next trading price"))
        self.stopPushButton.setText(_translate("MainWindow", "停止"))
        self.clearPushButton.setText(_translate("MainWindow", "清除日志"))
